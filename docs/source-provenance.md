...
- Alexa+ simulated experience and persistent context (planned).
- AWS deployment, observability, and audit history (planned).
- New tests, architecture diagram, public demo, and product feedback.
